            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    <button class="flex items-center space-x-2 text-sm focus:outline-none">
                        {{-- <span class="hidden md:block text-gray-700 font-medium capitalize">{{ $currentRole }}</span> --}}
                        {{-- <img class="h-8 w-8 rounded-full object-cover" src="https://ui-avatars.com/api/?name={{ $currentRole }}&background=047857&color=fff&size=256" alt="User Avatar"> --}}
                    </button>
                </div>
            </div>
