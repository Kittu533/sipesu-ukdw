...
<div class="space-y-8">
    ...
    <div class="flex justify-between items-end">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 tracking-tight">Dashboard Pejabat</h2>
            <p class="text-gray-500 mt-2">Selamat datang, <span class="font-semibold text-emerald-700">{{ Auth::user()->nama_lengkap }}</span>. Berikut adalah ringkasan dokumen yang perlu perhatian Anda.</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 uppercase tracking-wider">Menunggu Tanda Tangan</p>
                    <p class="text-4xl font-bold text-gray-900 mt-2">{{ $data['menunggu_persetujuan'] }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 uppercase tracking-wider">Telah Disetujui</p>
                    <p class="text-4xl font-bold text-gray-900 mt-2">{{ $data['disetujui'] }}</p>
