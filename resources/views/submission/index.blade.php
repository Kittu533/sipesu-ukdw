...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Riwayat Pengajuan Surat</h2>
            <p class="text-sm text-gray-500 mt-1">Pantau status pengajuan surat Anda di sini.</p>
        </div>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-lg font-medium text-gray-900">Belum ada pengajuan</p>
                                <p class="text-sm text-gray-500 mt-1">Mulai buat pengajuan surat pertama Anda sekarang.</p>
                                <a href="{{ route('submission.create') }}" class="mt-4 text-emerald-600 hover:text-emerald-700 font-medium text-sm">
